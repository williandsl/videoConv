...
import org.example.client.downloader.response.ResponseStatus;
...
public class ResponseImpl<T> implements Response<T> {
    ...
    @Override
    public org.example.client.downloader.response.ResponseStatus status() {
        if (error != null) {
            return org.example.client.downloader.response.ResponseStatus.error;
        }
        if (data != null) {
            if (data.isCancelled()) {
                return org.example.client.downloader.response.ResponseStatus.canceled;
            }
            ...
            try {
                ...
                return org.example.client.downloader.response.ResponseStatus.downloading;
            } catch (ExecutionException | InterruptedException e) {
                error = e;
                return org.example.client.downloader.response.ResponseStatus.error;
            }
            return org.example.client.downloader.response.ResponseStatus.completed;
        }
